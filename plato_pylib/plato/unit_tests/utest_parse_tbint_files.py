...
def loadPairPotCorr0SetADataToList():
	...
	return [ tCode.TbintIntegrals(inpFilePath=inpFilePath, atomAName=atomAName, atomBName=atomBName, integrals=pairPotIntVals) ]
...
def loadHopCorrIntsSetADataToList():
	...
	hopCorrInts.append( tCode.TbintIntegrals(inpFilePath=inpFilePath, atomAName=atomAName, atomBName=atomBName, shellA=0, shellB=0, angMomA=0, angMomB=0, orbSubIdx=1, integrals= hopCorrOrb00) )
	hopCorrInts.append( tCode.TbintIntegrals(inpFilePath=inpFilePath, atomAName=atomAName, atomBName=atomBName, shellA=0, shellB=1, angMomA=0, angMomB=1, orbSubIdx=1, integrals= hopCorrOrb01) )
	hopCorrInts.append( tCode.TbintIntegrals(inpFilePath=inpFilePath, atomAName=atomAName, atomBName=atomBName, shellA=1, shellB=0, angMomA=1, angMomB=0, orbSubIdx=1, integrals= hopCorrOrb10) )
	hopCorrInts.append( tCode.TbintIntegrals(inpFilePath=inpFilePath, atomAName=atomAName, atomBName=atomBName, shellA=1, shellB=1, angMomA=1, angMomB=1, orbSubIdx=1, integrals= hopCorrOrb11a) )
	hopCorrInts.append( tCode.TbintIntegrals(inpFilePath=inpFilePath, atomAName=atomAName, atomBName=atomBName, shellA=1, shellB=1, angMomA=1, angMomB=1, orbSubIdx=2, integrals= hopCorrOrb11b) )
